...
if __name__ == "__main__":
    ...
    assert config["WORKER_GRAD_ACCUMULATION_BATCH_SIZE"] % config["WORKER_BATCH_SIZE"] == 0, "WORKER_BATCH_SIZE must not exceed WORKER_GRAD_ACCUMULATION_BATCH_SIZE and should divise it ."
